---
name: report
description: Mostra o relatório da última execução da suíte e a tendência histórica das métricas, como a saúde da bateria ao longo do tempo.
---


# Relatório de Execuções — KDE Wayland
